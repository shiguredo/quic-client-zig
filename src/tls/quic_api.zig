...
pub fn QuicApi(
    ...
    return struct {
        ...
        pub fn init(
            ...
            comptime writeHandshakeDataFn: fn (ptr: @TypeOf(pointer), epoch: Epoch, data: []const u8) ApiError!usize,
        ) Self {
            ...
            const Gen = struct {
                ...
                pub fn writeHandshakeDataImpl(ptr: *anyopaque, epoch: Epoch, data: []const u8) ApiError!usize {
                    const self = @ptrCast(Ptr, @alignCast(alignment, ptr));
                    return @call(
                        .{ .modifier = .always_inline },
